...
<html lang="en">
  ...
  <div class="col-4">     </div>
            ...
            <div class="right">
              <img src="images/kads_landing_pic.png"  class="landing_pic" />
            </div>
          </div>
        </div>
    ...
    <div class ="container">
        ...
        <div class="row">
  <div class="col-8">
  <img src="IMAGES/left.png" alt="KADS" class="left-pic d-none d-sm-block" />

  </div>
 
  <div class="col-4">         
    <p class ="text2"> &#10024 Authentic Japanese Restaurant in the Philippines</p>
        <h1 class="about-kads">About KADS</h1>
         <p class="text1">
